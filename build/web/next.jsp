...
<body>
   ...
   <div class="container " >
       ...
       <div class="form-group">
                                <h1 style="text-align: center"><strong>SIGN UP WITH US</strong> </h1>
                                  <h2 style="text-align: center">Get notified within 3 working days *</h2>
                               <div class="form-group">
                                            <label>Email:</label>
                    ...
                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success btn-lg" onclick="window.location = 'customer.jsp';">Sign up now</button>
                           <!-- </div>-->
