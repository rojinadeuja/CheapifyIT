...
<body>
                ...
                <div class="col-md-12">
                    ...
                    <img src="assets/img/logo.png" />
                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="signin.jsp" class="menu-top-active">SIGN IN</a></li>
   ...
   <div class="container " >
       ...
       <div class="form-group">
                                <h1 style="text-align: center"><strong>SIGN IN</strong> </h1>
                    ...
                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success btn-lg" onclick="window.location = 'customer.jsp';">LOG IN</button>
                           <!-- </div>-->
