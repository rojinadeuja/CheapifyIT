...
<body>
   ...
   <div class="container " >
       ...
       <div class="form-group">
                                <h1 style="text-align: center"><strong>Do you want to specify more details? </strong> </h1>
                ...
                <div class="form-group">
                 ...
                 <button type="submit" class="btn btn-success btn-lg" onclick="window.location = 'next.jsp';">Done</button>
                           <!-- </div>-->
